...
class Config():
    ...
    def __init__(
            self,
            pump_lam = 405e-9, # [meter]
            pump_waist = 40e-6, # [meter]
            r_scale0 = 40e-6, # [meter]
            dk_offset = 1,
            d33 = 16.9e-12 , # nonlinear coefficient [meter/Volt] for ktp
            T = 50, # Temprute [Kelvin degrees]
            pump_power = 1e-3, # [W]
            idler_power = 1, # [W]
            signal_power = 1 # [W])
    ):
            ...
            self.pump_lam = 405e-9 # [meter]
            self.pump_waist = 40e-6 # [meter]
            self.r_scale0 = 40e-6 # [meter]
            self.dk_offset = 1
            self.d33 = 16.9e-12  # nonlinear coefficient [meter/Volt] for ktp
            self.T = 50 # Temprute [Kelvin degrees]
            self.pump_power = 1e-3 # [W]
            self.idler_power = 1 # [W]
            self.signal_power = 1 # [W]
